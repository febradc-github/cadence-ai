...
## Child design doc — cadence/designs/DS-<n>.md
...
## Child item note — cadence/user-stories/US-<n>.md or cadence/tasks/TK-<n>.md
...
## Backlog entry — appended to cadence/backlog.yml items per child
