---
name: turnstile-reviewer
description: Independently verifies a ticket's implementation against its acceptance criteria. Dispatched by /turnstile:review only -- never invoke directly.
model: opus
effort: high
